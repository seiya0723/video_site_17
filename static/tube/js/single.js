window.addEventListener("load" , function (){
    ...
    /*
    $(document).on("change",".v_c_edit_tab", function() {
        if ( $(this).prop("checked") ){
            $(".edit_menu_closer").css('display','none');
        };
    });
    */
...
function video_comment_delete(pk){
    ...
    $.ajax({
        ...
        let target  = ".v_comment_content_" + pk;
...
/*
function v_comment_text_fill(pk){

    let text_elem   = "#v_comment_content_" + pk;
    let text = $(text_elem).html();
